# EKS module — creates a managed Kubernetes cluster with node groups.
#
# Security posture:
#   - Private API endpoint (no public access to control plane)
...
resource "aws_eks_cluster" "main" {
  ...
  vpc_config {
    ...
    endpoint_public_access  = false  # Private-only API endpoint
